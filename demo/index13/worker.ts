/*
 * ProjectName: hypergl
 * FilePath: \demo\index13\worker.ts
 * Created Date: Friday, December 21st 2018, 3:12:40 pm
 * @author: dadigua
 * @summary: short description for the file
 * -----
 * Last Modified: Sunday, December 30th 2018, 6:36:44 pm
 * Modified By: dadigua
 * -----
...
import { Entity, StandardMaterial, Config, SkyMaterial, Application, Vec3, Color, Texture, CubeTexture, Vec2 } from 'hypergl';
...
async function main(canvas) {
    ...
    const app = new Application<{ loadImage: LoadImagePlugin }>(canvas as HTMLCanvasElement, {
        // webgl1:true
    });
    app.registerPlugins([LoadImagePlugin]);
